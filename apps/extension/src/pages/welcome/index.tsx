  ...
  return (
    <div className='min-h-screen min-w-screen gradient-cosmic flex flex-col relative overflow-hidden'>
      ...
      <header className='p-6 relative z-10'>
        <div className='flex items-center justify-between'>
          <div className='flex items-center gap-3'>
            ...
            <h1 className='text-xl font-bold text-foreground'>Cpay</h1>
          </div>
          ...
          <div className='flex gap-2'>
            ...
            >
              <CircleQuestionMark size={16} /> Learn More
            </Button>
          </div>
        </div>
      </header>
          ...
          <div className='space-y-8'>
            ...
            <div className='space-y-6'>
              <h1 className='text-6xl font-black text-foreground tracking-tight leading-none'>
                WELCOME TO
                <br />
                <span className='text-primary'>CPay</span>
              </h1>

              <p className='text-xl text-muted-foreground leading-relaxed max-w-md'>
                The World's most Simple to use Wallet.
              </p>
            </div>
      ...
      <footer className='p-6 text-center relative z-10'>
        <p className='text-sm text-muted-foreground/60'>Powered by Sei Network</p>
      </footer>
